<template>
    <div class="constancias-cumplimientos-view">
      <h1>Constancias de Cumplimientos</h1>
  ...
  const folders = ref([
    {
      id: 1,
      name: 'Cumplimientos 2023',
      documents: [
        { id: 1, name: 'Certificado 1.pdf' },
        { id: 2, name: 'Certificado 2.docx' },
      ],
    },
    {
      id: 2,
      name: 'Cumplimientos 2022',
      documents: [
        { id: 1, name: 'Certificado 1.pdf' },
        { id: 2, name: 'Certificado 2.docx' },
      ],
  ...
  const addFolder = () => {
    const newFolder = {
      ...
      name: `Cumplimientos ${new Date().getFullYear()}`,
      documents: [],
    };
  ...
  .constancias-cumplimientos-view {
    flex-grow: 1;
    padding: 2rem;
