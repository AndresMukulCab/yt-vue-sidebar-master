<template>
    <div class="evaluacion-diagnostica-view">
  ...
  const folders = ref([
    {
      id: 1,
      name: 'Evaluaciones 2023',
      documents: [
        { id: 1, name: 'Evaluación 1.pdf' },
        { id: 2, name: 'Evaluación 2.docx' },
      ],
    },
    {
      id: 2,
      name: 'Evaluaciones 2022',
      documents: [
        { id: 1, name: 'Evaluación 1.pdf' },
        { id: 2, name: 'Evaluación 2.docx' },
      ],
  ...
  const addFolder = () => {
    const newFolder = {
      ...
      name: `Evaluaciones ${new Date().getFullYear()}`,
      documents: [],
    };
